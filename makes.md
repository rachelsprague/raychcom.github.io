...
layout: default
title: Raych Makes
body_class: makes-page
---

<div class="landing-container">

  <!-- Logo / Icon -->
  <img src="/assets/images/raych_makes.png" alt="Raych's Turtle Cove logo" class="logo">

  <!-- Social media icons inline -->
  <div class="social-icons-inline">
    <a href="https://bsky.app/profile/makes.raych.com" target="_blank" rel="noopener" aria-label="Bluesky">
